...
Service Provider API that implements the provider registration endpoints _(POST
/resource/{resourceKind}/provider_ and related endpoints). When an SP registers,
